...
function toAIModel(entry: ReturnType<typeof getKieModelById>): AIModel | null {
  ...
  const caps: ModelCapabilities = {
    ...
    textToImage: entry.capabilities.textToImage,
    imageToImage: entry.capabilities.imageToImage,
    imageEdit: entry.capabilities.imageEdit,
    textToVideo: entry.capabilities.textToVideo,
    imageToVideo: entry.capabilities.imageToVideo,
    referenceToVideo: entry.capabilities.referenceToVideo,
    ...
    multiReference: entry.capabilities.multiReference,
    maxReferenceImages: entry.capabilities.maxReferenceImages,
    highResolution: entry.capabilities.highResolution,
    multiShot: entry.capabilities.multiShot,
    sound: entry.capabilities.sound,
