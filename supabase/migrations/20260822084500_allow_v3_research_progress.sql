-- Allow simplified Game Discovery v3 root jobs to write the same durable research trace as v2.
-- This is a compatibility hotfix discovered by the first zero-cost production smoke attempt.
...
SET schema_version = '20260822084500', updated_at = NOW()
